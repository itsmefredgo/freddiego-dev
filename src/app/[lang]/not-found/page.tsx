...
function NotFound() {
  return (
    <div>
      <main
        className={` ${mainDivWidth} font-semibold bg-background flex 
        items-center justify-center text-text duration-300 glow5 
        h-[calc(100vh-4rem)]`}
      >
        <div
...
const mainDivWidth = `sm:px-[min(calc((100%-36rem)/2),4rem)] 
