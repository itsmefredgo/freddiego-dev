...
/**
 * Renders a role in the about page.
 * @param role The role/occupation to render.
 * @param description The description of the role.
 * @param techstack The techstack of the role.
 * @param slug The slug of the role.
 * @returns The rendered role.
 */
function Role({ role, description, techstack, slug }: SummaryRole) {
  return (
    <li key={role} id={slug}>
      ...
      <ul
        className=" pt-2 flex flex-wrap  lg:justify-between gap-4 w-full 
        h-auto justify-wrap"
      >
